...
import { Upload, ArrowLeft, Plus, Loader2, Image as ImageIcon } from "lucide-react"
...
export default function AddProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!profile?.id) {
      toast.error("Unauthorized: Seller profile not found.")
      return
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display font-bold text-xl sm:text-2xl text-surface-50">Publish Product</h1>
          <p className="text-xs text-surface-400 mt-0.5">List a new technological item in the global catalog.</p>
        </div>
      </div>
